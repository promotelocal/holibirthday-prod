define([
	...
	'storyRowP',
	'submitButton',
], function (adminP, bar, bodyColumn, colors, confettiBackground, db, fonts, meP, months, profilesP, separatorSize, socialMedia, socialMediaButton, storiesP, storyRowP, submitButton) {
