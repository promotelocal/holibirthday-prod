...
module.exports = function (app, config, dbWith) {
	...
	app.schema.profile.postInsertMiddleware.use(function (profile, options, next) {
		next();
		return addProfileToHolibirthersList(profile, function () {});
	});
	app.schema.profile.postInsertMiddleware.use(function (profile, options, next) {
		next();
		return addProfileToFriendsList(profile, function () {});
	});
	...
	app.schema.profile.postUpdateMiddleware.use(function (profile, options, next) {
		return addUserToAllList(dbWith(function () {}), profile.user, function () {});
	});
